...
public class ReconfigurationConstraintP { 
...
//		}
	...
	static class SolutionEnumerator extends CpSolverSolutionCallback{
		...
		private LinearExpr toMax;
		  ...
		  public SolutionEnumerator(HashMap<String,HashMap<String,BoolVar>> runningVars, HashMap<String,IntVar> stateVars, LinearExpr toMax, Model m, IntVar NbMoved) {
